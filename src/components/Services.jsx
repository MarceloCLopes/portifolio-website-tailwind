      ...
      <div className='container mx-auto'>
        <div className='flex flex-col items-center text-center'>
          ...
          <p className='subtitle'>
            ...
            recusandae odit alias excepturi odio modi earum cumque, quisquam
            nesciunt. Delectus.
          </p>
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <div className='bg-secondary p-6 rounded-2xl' key={index}>
                <div className='text-accent rounded-sm w-12 h-12 flex justify-center items-center mb-24 text-3xl'>
                  {icon}
                </div>
